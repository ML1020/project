...
public class WaitTest {
    ...
    private static Semaphore SEMAPHORE= new Semaphore(0);  //初始许可证为0
...
//                    LATCH.countDown();//计数   i--
        ...
        //main在所有子线程执行完毕之后，再运行以下的代码
        //LATCH.await(); //await()阻塞型一直等待，直到LATCH的值==0
        SEMAPHORE.acquire(5);//无参代表请求资源数量为1，也可以请求指定数量的资源，请求足够的资源后才会执行
        System.out.println(Thread.currentThread().getName());
    }
}
